...
function DefaultWeather({width, height, color, animations}) {// les valeurs du width,height.. on les trouve dans SvgHoc.jsx
    const getColor = (value) => { // pour qu on change la couleur de l icon
        if (color) {
            return '#fff';
        }
        switch (value) {
